  ...
  if ((appData != NULL) || (params != NULL))
  {
    ...
    switch (appData->Port)
    {
      ...
      case LORAWAN_USER_APP_PORT:
    	  APP_LOG(TS_OFF, VLEVEL_M, "Downling in user port..\r\n");
...
static void SendTxData(void)
{
  ...
  uint32_t bowl_weight = GetBowlWeight();

  // Place bowl weight into the buffer, BIG ENDIAN
//  AppData.Buffer[i++] = (uint8_t)((bowl_weight >> 24) & 0xFF);
